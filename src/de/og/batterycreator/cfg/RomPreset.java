...
public class RomPreset {
	...
	public static final int WEATHER_MDPI = 75;
	...
	public static final int TOGGLE_MDPI = 38;
	public static final int TOGGLE_HDPI = 48;
	public static final int TOGGLE_XHDPI_S3 = 72;

	public static final int NOTIFICATION_MDPI = 3;
	...
	static {
		presets.add(new RomPreset(APPLY, DRAWABLE_XHDPI, BATT_ICON_HEIGHT_XHDPI, DRAWABLE_HDPI, BATT_ICON_NAME_AOKP,
		...
		presets.add(new RomPreset("Default (hdpi AOKP)", DRAWABLE_HDPI, BATT_ICON_HEIGHT_HDPI, DRAWABLE_HDPI,
				BATT_ICON_NAME_AOKP, BATT_ICON_CHARGE_NAME_AOKP, LOCK_HDPI, NOTIFICATION_HDPI, TOGGLE_HDPI, false,
				WEATHER_HDPI, templateS2, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));
		presets.add(new RomPreset("Default (xhdpi AOKP)", DRAWABLE_XHDPI, BATT_ICON_HEIGHT_XHDPI, DRAWABLE_XHDPI,
				BATT_ICON_NAME_AOKP, BATT_ICON_CHARGE_NAME_AOKP, LOCK_XHDPI, NOTIFICATION_XHDPI, TOGGLE_XHDPI, false,
				WEATHER_XHDPI, templateS2, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));
		presets.add(new RomPreset("Default (mhdpi AOKP)", DRAWABLE_MDPI, BATT_ICON_HEIGHT_MDPI, DRAWABLE_MDPI,
				BATT_ICON_NAME_AOKP, BATT_ICON_CHARGE_NAME_AOKP, LOCK_MDPI, NOTIFICATION_MDPI, TOGGLE_MDPI, false,
				WEATHER_MDPI, templateS2, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));

		// Rootbox
		presets.add(new RomPreset("(S2 i9100) ### RootBox 3.x", DRAWABLE_HDPI, BATT_ICON_HEIGHT_HDPI, DRAWABLE_HDPI,
				BATT_ICON_NAME_AOKP, BATT_ICON_CHARGE_NAME_AOKP, LOCK_HDPI, NOTIFICATION_HDPI, TOGGLE_HDPI, false,
				WEATHER_HDPI, templateS2, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));
		presets.add(new RomPreset("(S2 i9100) ### RootBox 3.x (Speedometer)", DRAWABLE_HDPI, BATT_ICON_HEIGHT_HDPI,
				DRAWABLE_HDPI, BATT_ICON_NAME_ROOTBOX_ALT, BATT_ICON_CHARGE_NAME_ROOTBOX_ALT, LOCK_HDPI, NOTIFICATION_HDPI,
				TOGGLE_HDPI, false, WEATHER_HDPI, templateS2, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));
		presets.add(new RomPreset("(S2 i9100) ### RootBox 3.x (Square)", DRAWABLE_HDPI, BATT_ICON_HEIGHT_HDPI, DRAWABLE_HDPI,
				BATT_ICON_NAME_ROOTBOX_SQUARE, BATT_ICON_CHARGE_NAME_ROOTBOX_SQUARE, LOCK_HDPI, NOTIFICATION_HDPI, TOGGLE_HDPI,
				false, WEATHER_HDPI, templateS2, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));

		// Resurrection
		presets.add(new RomPreset("(S2 i9100) Resurrection Remix 3.1.3 and above", DRAWABLE_XHDPI, BATT_ICON_HEIGHT_XHDPI,
				DRAWABLE_XHDPI, BATT_ICON_NAME_AOKP, BATT_ICON_CHARGE_NAME_AOKP, LOCK_XHDPI, NOTIFICATION_XHDPI, TOGGLE_XHDPI,
				false, WEATHER_XHDPI, templateS2, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));

		// other
		presets.add(new RomPreset("(S2 i9100) JellyBam 4.x - 5.x", DRAWABLE_HDPI, BATT_ICON_HEIGHT_HDPI, DRAWABLE_HDPI,
				BATT_ICON_NAME_AOKP, BATT_ICON_CHARGE_NAME_AOKP, LOCK_HDPI, NOTIFICATION_HDPI, TOGGLE_HDPI, false,
				WEATHER_HDPI, templateS2, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));
		presets.add(new RomPreset("(S2 i9100) Chameleon v3.0 AOKP hybrid", DRAWABLE_HDPI, BATT_ICON_HEIGHT_HDPI, DRAWABLE_HDPI,
				BATT_ICON_NAME_AOKP, BATT_ICON_CHARGE_NAME_AOKP, LOCK_HDPI, NOTIFICATION_HDPI, TOGGLE_HDPI, false,
				WEATHER_HDPI, templateS2, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));
		presets.add(new RomPreset("(S2 i9100) Original AOKP", DRAWABLE_HDPI, BATT_ICON_HEIGHT_HDPI, DRAWABLE_HDPI,
				BATT_ICON_NAME_AOKP, BATT_ICON_CHARGE_NAME_AOKP, LOCK_HDPI, NOTIFICATION_HDPI, TOGGLE_HDPI, false,
				WEATHER_HDPI, templateS2, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));
		...
		presets.add(new RomPreset("(S2 i9100) HydraH2O ICS 1.x", DRAWABLE_HDPI, BATT_ICON_HEIGHT_HDPI, DRAWABLE_HDPI,
				BATT_ICON_NAME_AOKP, BATT_ICON_CHARGE_NAME_AOKP, LOCK_HDPI, NOTIFICATION_HDPI, TOGGLE_HDPI, false,
				WEATHER_HDPI, templateS2, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));

		presets.add(new RomPreset("(S2 i9100) Original CM9/CM10/10.1 + 1%-Mod!!!", DRAWABLE_HDPI, BATT_ICON_HEIGHT_HDPI,
				DRAWABLE_HDPI, BATT_ICON_NAME_AOKP, BATT_ICON_CHARGE_NAME_AOKP, LOCK_HDPI, NOTIFICATION_HDPI, TOGGLE_HDPI,
				false, WEATHER_HDPI, templateS2, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));

		presets.add(new RomPreset("(S2 i9100) Stock ROM incl. JKay", DRAWABLE_HDPI, BATT_ICON_HEIGHT_HDPI, DRAWABLE_HDPI,
				BATT_ICON_NAME_STOCK_ICS_JKAY, BATT_ICON_CHARGE_NAME_STOCK_ICS_JKAY, LOCK_HDPI, NOTIFICATION_HDPI, TOGGLE_HDPI,
				false, WEATHER_HDPI, templateS2, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));

		presets.add(new RomPreset("(S2 i9100) Presets for 1%Mod from shayne77 Mod-Tool", DRAWABLE_HDPI, BATT_ICON_HEIGHT_HDPI,
				DRAWABLE_HDPI, BATT_ICON_NAME_STOCK_ICS_JKAY, BATT_ICON_CHARGE_NAME_STOCK_ICS_JKAY, LOCK_HDPI,
				NOTIFICATION_HDPI, TOGGLE_HDPI, false, WEATHER_HDPI, templateS2, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));

		// S3 Presets
		presets.add(new RomPreset("(S3 i9300) [MORPHOLOGY SOCIETY]", DRAWABLE_HDPI, BATT_ICON_HEIGHT_HDPI_S3, DRAWABLE_HDPI,
				BATT_ICON_NAME_STOCK_ICS_JKAY, BATT_ICON_CHARGE_NAME_STOCK_ICS_JKAY, LOCK_XHDPI, NOTIFICATION_XHDPI,
				TOGGLE_XHDPI_S3, true, WEATHER_XHDPI, templateS2, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));
		presets.add(new RomPreset("(S3 i9300) Stock [sdcard under /data/media]", DRAWABLE_XHDPI, BATT_ICON_HEIGHT_XHDPI,
				DRAWABLE_XHDPI, BATT_ICON_NAME_STOCK_ICS_JKAY, BATT_ICON_CHARGE_NAME_STOCK_ICS_JKAY, LOCK_XHDPI,
				NOTIFICATION_XHDPI, TOGGLE_XHDPI_S3, true, WEATHER_XHDPI, templateS3Nexus, MORPHPATH_SYSTEMUI,
				MORPHPATH_FRAMEWORK));
		presets.add(new RomPreset("(S3 i9300) Omega Rom", DRAWABLE_XHDPI, BATT_ICON_HEIGHT_XHDPI_S3, DRAWABLE_XHDPI,
				BATT_ICON_NAME_STOCK_ICS_JKAY, BATT_ICON_CHARGE_NAME_STOCK_ICS_JKAY, LOCK_XHDPI, NOTIFICATION_XHDPI,
				TOGGLE_XHDPI, false, WEATHER_XHDPI, templateS3Nexus, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));
		presets.add(new RomPreset("(S3 i9300) ### RootBox 3.x ", DRAWABLE_XHDPI, BATT_ICON_HEIGHT_XHDPI, DRAWABLE_XHDPI,
				BATT_ICON_NAME_AOKP, BATT_ICON_CHARGE_NAME_AOKP, LOCK_XHDPI, NOTIFICATION_XHDPI, TOGGLE_XHDPI, false,
				WEATHER_XHDPI, templateS3Nexus, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));
		presets.add(new RomPreset("(S3 i9300) ### RootBox 3.x (Speedometer)", DRAWABLE_XHDPI, BATT_ICON_HEIGHT_XHDPI,
				DRAWABLE_XHDPI, BATT_ICON_NAME_ROOTBOX_ALT, BATT_ICON_CHARGE_NAME_ROOTBOX_ALT, LOCK_XHDPI, NOTIFICATION_XHDPI,
				TOGGLE_XHDPI, false, WEATHER_XHDPI, templateS3Nexus, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));
		presets.add(new RomPreset("(S3 i9300) ### RootBox 3.x (Square)", DRAWABLE_XHDPI, BATT_ICON_HEIGHT_XHDPI,
				DRAWABLE_XHDPI, BATT_ICON_NAME_ROOTBOX_SQUARE, BATT_ICON_CHARGE_NAME_ROOTBOX_SQUARE, LOCK_XHDPI,
				NOTIFICATION_XHDPI, TOGGLE_XHDPI, false, WEATHER_XHDPI, templateS3Nexus, MORPHPATH_SYSTEMUI,
				MORPHPATH_FRAMEWORK));
		presets.add(new RomPreset("(S3 i9300/i747) Pacman Rom", DRAWABLE_XHDPI, BATT_ICON_HEIGHT_XHDPI, DRAWABLE_XHDPI,
				BATT_ICON_NAME_ROOTBOX_SQUARE, BATT_ICON_CHARGE_NAME_ROOTBOX_SQUARE, LOCK_XHDPI, NOTIFICATION_XHDPI,
				TOGGLE_XHDPI, false, WEATHER_XHDPI, templateS3Nexus43, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));
		// Galaxy Nexus Presets
		presets.add(new RomPreset("(Galaxy Nexus) ### RootBox 3.x ", DRAWABLE_XHDPI, BATT_ICON_HEIGHT_XHDPI, DRAWABLE_XHDPI,
				BATT_ICON_NAME_AOKP, BATT_ICON_CHARGE_NAME_AOKP, LOCK_XHDPI, NOTIFICATION_XHDPI, TOGGLE_XHDPI, false,
				WEATHER_XHDPI, templateS3Nexus, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));
		presets.add(new RomPreset("(Galaxy Nexus) ### RootBox 3.x (Speedometer)", DRAWABLE_XHDPI, BATT_ICON_HEIGHT_XHDPI,
				DRAWABLE_XHDPI, BATT_ICON_NAME_ROOTBOX_ALT, BATT_ICON_CHARGE_NAME_ROOTBOX_ALT, LOCK_XHDPI, NOTIFICATION_XHDPI,
				TOGGLE_XHDPI, false, WEATHER_XHDPI, templateS3Nexus, MORPHPATH_SYSTEMUI, MORPHPATH_FRAMEWORK));
		presets.add(new RomPreset("(Galaxy Nexus) ### RootBox 3.x (Sqare)", DRAWABLE_XHDPI, BATT_ICON_HEIGHT_XHDPI,
				DRAWABLE_XHDPI, BATT_ICON_NAME_ROOTBOX_SQUARE, BATT_ICON_CHARGE_NAME_ROOTBOX_SQUARE, LOCK_XHDPI,
				NOTIFICATION_XHDPI, TOGGLE_XHDPI, false, WEATHER_XHDPI, templateS3Nexus, MORPHPATH_SYSTEMUI,
				MORPHPATH_FRAMEWORK));
	}
	...
	public RomPreset(final String romName, final String systemUIDrawableFolder, final int battsize,
			final String frameworkDrawableFolder, final String filePattern, final String filePatternCharge,
			final int lockHandleSize, final int notificationHeight, final int toggleSize, final boolean useLidroid,
			final int weatherSize, final String template, final String morphPath2SystemUIRes,
