 ...
 * 
 */
public class CircleCreatorV1 extends AbstractIconCreator {

	protected static String	name	= "CircleMod.V1";

	public CircleCreatorV1(final RomSettings romSettings) {
		super(romSettings);
	...
	public ImageIcon createImage(final int percentage, final boolean charge) {
		...
		if (settings.isFlip())
			Draw2DFunktions.fillCircle(g2d, x, x, radius, 90, -Math.round(percentage * (360f / 100f)));
		else
			Draw2DFunktions.fillCircle(g2d, x, y, radius, 90, +Math.round(percentage * (360f / 100f)));
