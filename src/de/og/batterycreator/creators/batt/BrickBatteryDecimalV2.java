...
public class BrickBatteryDecimalV2 extends AbstractIconCreator {

	public BrickBatteryDecimalV2(final RomSettings romSettings) {
		super(romSettings);
	}

	protected static String	name	= "BrickBattery.Decimal.V2";
