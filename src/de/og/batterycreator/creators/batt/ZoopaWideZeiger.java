...
public class ZoopaWideZeiger extends AbstractIconCreator {

	protected static String	name	= "Zoopa.Wide.Zeiger";

	public ZoopaWideZeiger(final RomSettings romSettings) {
		super(romSettings);
